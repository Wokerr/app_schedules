    ...
    <div class="md:w-4/12 bg-white p-6 rounded-xl">
        <form action="{{route('register')}}" method="POST" novalidate>
            ...
            <div class="mb-5">
                ...
                <input type="text" id="Username" placeholder="Username" name="username" value="{{ old('username') }}" class="border p-3 w-full rounded-lg h-10 @error('username') border-red-600 @enderror"> 

                @error('username') <span class=" bg-red-500 text-center block text-white font-bold rounded-lg mt-3 p-2"> {{$message}} </span> @enderror
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="email" id="email" placeholder="example: appschedules@schedules.com" name="email" value="{{ old('email') }}" class="border p-3 w-full rounded-lg h-10 @error('email') border-red-600 @enderror">

                @error('email') <span class=" bg-red-500 text-center block text-white font-bold rounded-lg mt-3 p-2"> {{$message}} </span> @enderror
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="password" id="password" placeholder="" name="password" class="border p-3 w-full rounded-lg h-10 @error('password') border-red-600 @enderror"> 

                @error('password') <span class=" bg-red-500 text-center block text-white font-bold rounded-lg mt-3 p-2"> {{$message}} </span> @enderror
            </div>
